...
Sub Globals
	...
	Dim lb As Label
	Dim mm As Typeface : mm = mm.LoadFromAssets("TaGu.ttf")
	Dim msg As Label
End Sub
...
Sub Activity_Create(FirstTime As Boolean)
	...
	lb.Text = "	Install  ကိုနွိပ္ပါ။ ျပီးရင္ေအာက္ပါ Change Font1 ကိုနွိပ္ပါ TaGu.txj (သို့) TaGu.itz ကိုဖြင့္ၿပီး Apply လုပ္ေပးလိုက္ပါ မရခဲ့ရင္ Change Font2 ကိုနွိပ္ျပီး Myanmar TaGu နာမည္နဲ့ Theme ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ Change Font2 ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"
	...
	Banner.Initialize2("Banner","ca-app-pub-4173348573252986/9207568554",Banner.SIZE_SMART_BANNER)
	Dim height As Int
	...
	Interstitial.Initialize("Interstitial","ca-app-pub-4173348573252986/3161034954")
	Interstitial.LoadAd
...
Sub b1_Click
	...
	If File.Exists(File.DirRootExternal & "/Vivo Myanmar Font","TaGu.txj") = True Then File.Delete(File.DirRootExternal,"Vivo Myanmar Font/TaGu.txj")
	File.Copy(File.DirAssets,"TaGu.txj",File.DirRootExternal & "/Vivo Myanmar Font","TaGu.txj")
	
	If File.Exists(File.DirRootExternal & "/Vivo Myanmar Font","TaGu.itz") = True Then File.Delete(File.DirRootExternal,"Vivo Myanmar Font/TaGu.itz")
	File.Copy(File.DirAssets,"TaGu.itz",File.DirRootExternal & "/Vivo Myanmar Font","TaGu.itz")
...
Sub b2_Click
	...
	Catch
		...
		b1.Visible=False
		b2.Visible=False
		msg.Text = "File Manager တစ္ခုခုထဲသို႔သြားၿပီး Vivo Myanmar Font ဖိုဒါထဲကိုဝင္ပါ။ TaGu.txj (သို့) TaGu.itz ကိုဖြင့္ၿပီး Apply လုပ္ေပးလိုက္ပါ သို႔မဟုတ္ Change Font2 နဲ႔ထပ္သြင္းပါ။"
		ad1.Enabled =True
	End Try
End Sub
...
Sub b4_Click
	...
	If File.Exists(File.DirRootExternal & "/Download/i Theme/Font","TaGu.txj") = True Then File.Delete(File.DirRootExternal,"Download/i Theme/Font/TaGu.txj")
	File.Copy(File.DirAssets,"TaGu.txj",File.DirRootExternal & "/Download/i Theme/Font","TaGu.txj")
	
	If File.Exists(File.DirRootExternal & "/Download/i Theme/Font","TaGu.itz") = True Then File.Delete(File.DirRootExternal,"Download/i Theme/Font/TaGu.itz")
	File.Copy(File.DirAssets,"TaGu.itz",File.DirRootExternal & "/Download/i Theme/Font","TaGu.itz")
	Try
		Dim i As Intent
		i.Initialize("", "")
...
Sub b3_Click
	...
	b1.Visible=False
	b2.Visible=False
	msg.Text = "Install ကိုႏွိပ္ၿပီးတာနဲ႔ ဖုန္းမွာ Default File Manager တစ္ခုခုမေရြးထားရင္ေတာ့ ကိုယ့္ဘာသာကို ဖုန္းထဲက File Manager တစ္ခုခုထဲကိုသြားလိုက္ပါ။	ၿပီးရင္ Vivo Myanmar Font ဆိုတဲ့ဖိုဒါကိုရွာၿပီး ဝင္လိုက္ပါ။ အဲ့ဖိုဒါထဲမွာ TaGu.txj (သို့) TaGu.itz ဆိုတဲ့ဖိုင္ေလးကိုဖြင့္ၿပီး Apply ေပးလိုက္ပါ။ အဆင္မေျပတာမ်ားရွိရင္ Facebook က Myanmar Android App မွာလာေမးနိုင္ပါတယ္ :)"
	ad1.Enabled = True
End Sub
...
Sub SlideMenu_Click(Item As Object)
	...
	Select Item
		...
		Case 7 :
			...
			copy.clrText
			copy.setText("#Myanmar_TaGu_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+TaGu+Font")
