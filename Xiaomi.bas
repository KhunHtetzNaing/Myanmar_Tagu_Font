...
Sub Activity_Create(FirstTime As Boolean)
	...
	lb.Text = "	Install ကိုနွိပ္ျပီး ေဖာင့္ေရြးထည့္ေပးပါ။ ျပီးရင္ေအာက္ပါ Change Font ကိုနွိပ္ျပီး System Font မွာ Myanmar TaGu Font ကိုေရြးေပးလိုက္ပါ။ သို့မဟုတ္ Theme ထဲက Font မွာ Myanmar TaGu Font ကိုေရြးျပီး Apply ေပးပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ Change Font ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"
...
Sub b1_Click
	...
	'	If File.Exists(File.DirRootExternal & "/MIUI/theme","TaGu.mtz") = True Then File.Delete(File.DirRootExternal,"MIUI/theme/TaGu.mtz")
	'	File.Copy(File.DirAssets,"TaGu.mtz",File.DirRootExternal & "/MIUI/theme","TaGu.mtz")
