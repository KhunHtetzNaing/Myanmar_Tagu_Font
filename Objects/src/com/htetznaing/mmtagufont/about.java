...
public class about extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmtagufont", "com.htetznaing.mmtagufont.about");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmtagufont", "com.htetznaing.mmtagufont.about");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmtagufont.about", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
_lblname.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 46;BA.debugLine="lblName.Text = \"Myanmar TaGu Font\"";
_lblname.setText(BA.ObjectToCharSequence("Myanmar TaGu Font"));
...
mostCurrent._lstone.getSingleLineLayout().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
 //BA.debugLineNum = 61;BA.debugLine="lstOne.AddSingleLine2(\"App Name : Myanmar TaGu Fo";
mostCurrent._lstone.AddSingleLine2(BA.ObjectToCharSequence("App Name : Myanmar TaGu Font"),(Object)(1));
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 80;BA.debugLine="tlb.Text = \"Myanmar TaGu Font\"";
mostCurrent._tlb.setText(BA.ObjectToCharSequence("Myanmar TaGu Font"));
 //BA.debugLineNum = 81;BA.debugLine="tlb.Color = Colors.rgb(0, 150, 136)";
