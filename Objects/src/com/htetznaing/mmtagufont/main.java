...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmtagufont", "com.htetznaing.mmtagufont.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmtagufont", "com.htetznaing.mmtagufont.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmtagufont.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._atx._initialize(mostCurrent.activityBA,"atx",main.getObject(),(int) (200));
 //BA.debugLineNum = 53;BA.debugLine="atx.Run( \" ♡ တန္ခူးလ သၾကၤန္ပြဲ ♡\" &CRLF& \"Myanmar";
mostCurrent._atx._run(" ♡ တန္ခူးလ သၾကၤန္ပြဲ ♡"+anywheresoftware.b4a.keywords.Common.CRLF+"Myanmar Font Style",(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._lb.getObject())));
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 98;BA.debugLine="tlb.Text = \"Myanmar TaGu Font\"";
mostCurrent._tlb.setText(BA.ObjectToCharSequence("Myanmar TaGu Font"));
 //BA.debugLineNum = 99;BA.debugLine="tlb.Color = Colors.rgb(0, 150, 136)";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 299;BA.debugLine="copy.setText(\"#Myanmar_TaGu_Font App! Beautiful M";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 277;BA.debugLine="copy.setText(\"#Myanmar_TaGu_Font App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_TaGu_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+TaGu+Font");
