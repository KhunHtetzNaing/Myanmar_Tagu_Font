...
public class tutorial extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmtagufont", "com.htetznaing.mmtagufont.tutorial");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmtagufont", "com.htetznaing.mmtagufont.tutorial");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmtagufont.tutorial", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._tlb.setText(BA.ObjectToCharSequence("Tutorial"));
 //BA.debugLineNum = 28;BA.debugLine="tlb.Color = Colors.rgb(0, 150, 136)";
